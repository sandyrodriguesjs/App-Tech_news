      ...
      <section className="latest-news mb-8 mt-3">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <article className="flex rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <h3 className="text-lg font-medium mb-2">10 anos do Spotify no Brasil: 5 curiosidades sobre o streaming de música</h3>
              <p className="text-base text-gray-700 line-clamp-3">
          ...
          <article className="flex rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <h3 className="text-lg font-medium mb-2">Google Fotos: 6 novos recursos de IA que você precisa testar agora no app</h3>
              <p className="text-base text-gray-700 line-clamp-3">
          ...
          <article className="flex rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <h3 className="text-lg font-medium mb-2">Headset gamer Redragon: confira 6 fones bons e baratos para jogar</h3>
              <p className="text-base text-gray-700 line-clamp-3">
          ...
          <article className="flex rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              <h3 className="text-lg font-medium mb-2">Android 15 pode aumentar a duração da bateria em até 3 horas; entenda2</h3>
              <p className="text-base text-gray-700 line-clamp-3">
